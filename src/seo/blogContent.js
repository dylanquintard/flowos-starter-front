export const BLOG_ARTICLES = [
  {
    ...
    description:
      "Ce qui distingue vraiment une pizza napolitaine: le travail de pâte, la cuisson, la lecture du four et l equilibre final en bouche.",
    excerpt:
      "Une pizza napolitaine reussie ne tient pas a un discours marketing. Elle se reconnait a la pâte, au rythme de cuisson et a la retenue dans les garnitures.",
    intro: [
      ...
      "Ce style repose sur une pâte vivante, une cuisson tres courte et une construction volontairement sobre. L objectif n est pas d accumuler les ingredients, mais d obtenir un ensemble net et leger.",
    ...
    sections: [
      {
        heading: "La pâte n est pas un support, c est le coeur du produit",
        blocks: [
          {
            ...
            paragraphs: [
              ...
              "Le type de farine, l hydratation, la temperature de travail et le temps de repos influencent directement la souplesse de la pâte et sa reaction au four.",
          ...
          },
          {
            ...
            paragraphs: [
              ...
              "Quand la pâte a eu le temps de maturer correctement, la pizza reste plus legere et plus lisible, meme avec une cuisson nerveuse.",
        ...
        blocks: [
          {
            ...
            paragraphs: [
              "La pizza napolitaine se cuit dans une fenêtre tres breve. Cela demande un four tres chaud, mais surtout une lecture precise de la pizza pendant la cuisson.",
              ...
              "Dire qu une pizza cuit vite ne suffit pas. Ce qui compte, c est la capacité a sortir chaque pizza au bon moment, pas simplement a aller vite.",
            ],
          },
          {
            ...
            paragraphs: [
              ...
              "Si la pâte casse, seche ou se tasse, le style est déjà perdu. La texture sert donc de preuve concrete, bien plus que les mots du menu.",
        ...
        blocks: [
          {
            ...
            paragraphs: [
              "Sur une pizza napolitaine, la garniture n est pas la pour cacher la pâte. Elle doit l accompagner.",
          ...
          },
          {
            ...
            paragraphs: [
              ...
              "Quand la pâte, la sauce et le fromage parlent clairement, le produit gagne en identite sans forcer l effet.",
      ...
      },
      {
        ...
        blocks: [
          ...
          },
          {
            ...
            paragraphs: [
              "En service mobile, il faut concilier qualité, cadence et retrait rapide. L execution doit rester propre malgre un environnement plus contraint qu en salle.",
    ...
    conclusion: [
      ...
      "La qualité finale depend autant de la pâte et du four que de la capacité a rester mesure dans la garniture. Tout se joue dans l equilibre.",
  ...
  },
  {
    ...
    excerpt:
      "Le four ne sert pas seulement a cuire. Il determine la texture de la pâte, la tenue de la garniture et le rythme global du service.",
    intro: [
    ...
    sections: [
      {
        ...
        blocks: [
          {
            subheading: "Une cuisson vive qui protege la pâte",
            paragraphs: [
              ...
              "Avec un four trop lent, la pâte seche avant de s ouvrir correctement. On perd alors la legerete recherchee sur une pizza napolitaine.",
          ...
          },
          {
            ...
            paragraphs: [
              "Quand la temperature baisse, la cuisson s allonge et la pizza change de profil. La sauce se concentre davantage, le fromage se fige plus vite et la pâte gagne en secheresse.",
        ...
        blocks: [
          ...
          },
          {
            ...
            paragraphs: [
              ...
              "Une bonne cuisson reste donc un dialogue entre le four, la pâte et l oeil du pizzaiolo.",
            ],
          },
        ],
      },
        ...
        blocks: [
          {
            ...
            paragraphs: [
              ...
              "Le bon rendu n est pas seulement plus gourmand. Il inspire aussi davantage de confiance sur la qualité globale du service.",
            ],
          },
          {
  ...
  },
  {
    ...
    intro: [
      "Dans une pizza serieuse, les ingredients ne sont pas un detail secondaire derriere la pâte. Ils definissent la finesse du gout et l identite de chaque recette.",
    ...
    sections: [
      {
        ...
        blocks: [
          {
            subheading: "Une sauce qui relie la pâte et le fromage",
            paragraphs: [
          ...
          },
          {
            ...
            paragraphs: [
              ...
              "Moins il y a d artifice, plus la qualité du produit devient visible.",
        ...
        blocks: [
          {
            ...
            paragraphs: [
              ...
              "Sur une pizza napolitaine, la mozzarella ne doit pas noyer la pâte. Elle doit l accompagner.",
            ],
          },
          {
        ...
        blocks: [
          {
            ...
            paragraphs: [
              ...
              "Une charcuterie trop dominante casse vite l equilibre entre pâte, tomate et fromage.",
          ...
          },
          {
            ...
            paragraphs: [
              "La qualité des ingredients depend aussi de la gestion des stocks, du rythme de rotation et de la preparation avant service.",
      ...
      {
        heading: "Le client lit la qualité sans avoir besoin des coulisses",
        blocks: [
          {
  ...
  },
  {
    ...
    description:
      "Pourquoi cette farine revient souvent dans les pâtes napolitaines travaillees pour la fermentation longue et la legerete.",
    excerpt:
      "La farine n est pas un detail technique reserve aux professionnels. Elle influence directement la tenue de la pâte, son alveolage et la regularite au service.",
    intro: [
      "Quand une pâte a pizza parait souple, legerement aerienne et stable au faconnage, la farine y est pour beaucoup. Le choix de la farine conditionne une partie importante du comportement de la pâte.",
      "Parmi les references souvent citees dans l univers napolitain, la Nuvola Super revient regulierement pour sa tolerance aux fermentations longues et sa capacité a soutenir des pâtes legeres.",
      "Cela ne fait pas tout, mais c est un socle solide quand on cherche un resultat regulier en service.",
    ],
    sections: [
      {
        heading: "La farine pilote une partie du comportement de la pâte",
        blocks: [
          {
            subheading: "Une base technique tres concrete",
            paragraphs: [
              "La farine influe sur l elasticite, la souplesse et la reaction de la pâte au repos puis au four.",
              "Une farine mal adaptee rend souvent le travail plus instable: la pâte colle, se retracte ou manque de tenue a l etalage.",
          ...
          },
          {
            ...
            paragraphs: [
              ...
              "Le client n identifie pas forcement ce paramêtre, mais il ressent une pizza moins compacte et plus agreable a manger.",
            ],
          },
        ],
      },
        ...
        blocks: [
          {
            ...
            paragraphs: [
              "Cette farine est souvent retenue pour des pâtes qui doivent tenir dans le temps sans perdre leur comportement.",
              "Cela aide a organiser la production plus sereinement, surtout quand le service demande d anticiper.",
              "Le pizzaiolo gagne en stabilite de travail, ce qui compte autant que la qualité brute de la farine.",
            ],
          },
          {
      ...
      },
      {
        ...
        blocks: [
          {
            subheading: "Une pâte plus lisible au four",
            paragraphs: [
              "Sur une cuisson tres chaude, la pâte doit tenir sans se crisper ni s effondrer.",
              "Avec une farine adaptee, la pizza garde mieux sa structure et reagit de facon plus nette dans cette fenêtre de cuisson tres courte.",
          ...
          },
          {
            ...
            paragraphs: [
              "En service mobile, la marge d erreur est plus faible. Il faut une pâte reguliere, facile a lire et a repeter.",
              "Une farine comme la Nuvola Super aide a rendre le process moins aleatoire, ce qui est precieux pour tenir la qualité sur la duree.",
        ...
        blocks: [
          {
            ...
            paragraphs: [
              ...
              "La qualité finale depend toujours d une chaine complete: matiere, protocole, execution et constance.",
          ...
          },
          {
            ...
            paragraphs: [
              "Documenter un protocole n enleve rien au metier. Cela protege au contraire le niveau de qualité.",
    ...
    conclusion: [
      "La Nuvola Super est une farine interessante parce qu elle facilite un certain type de pâte: plus stable, plus aerienne, plus lisible au service.",
  ...
  },
  {
    ...
    excerpt:
      "Une bonne tomate donne du relief a la sauce sans ecraser la pâte. C est pour cela que les San Marzano restent si souvent citees.",
    intro: [
        ...
        blocks: [
          {
            ...
            paragraphs: [
              ...
              "Elles permettent de construire une sauce qui accompagne la pâte sans l ecraser et qui reste compatible avec une mozzarella bien dosee.",
          ...
          },
          {
            ...
            paragraphs: [
              "Une sauce trop aqueuse dêtrempe vite la base. Une sauce trop concentree durcit la lecture globale de la pizza.",
              "Les San Marzano offrent une matiere qui se prête bien a une preparation simple et a une cuisson courte.",
        ...
        blocks: [
          {
            ...
            paragraphs: [
              ...
              "Avec une telle sobriete, la qualité de la tomate devient immediatement visible.",
          ...
          {
            subheading: "Un bon dialogue avec la pâte et le fromage",
            paragraphs: [
        ...
        blocks: [
          {
            ...
            paragraphs: [
              "Pour un professionnel, la constance compte autant que la qualité pure. Le client doit retrouver un meme profil de sauce au fil des commandes.",
              "Travailler une reference stable simplifie les reglages et limite les variations pendant le service.",
              "Dans un camion pizza, cette fiabilite soulage la production autant qu elle sécurise le resultat final.",
            ],
          },
          {
            subheading: "Une qualité percue sans discours excessif",
            paragraphs: [
              "Le client remarque rarement une tomate par son nom, mais il identifie vite une sauce nette et bien equilibree.",
              "Cette perception suffit a renforcer la confiance dans la qualité artisanale du produit.",
        ...
        blocks: [
          {
            ...
            paragraphs: [
              ...
              "Les San Marzano ne sont pas une formule magique, mais elles s accordent bien avec une carte simple, une bonne pâte et une cuisson vive.",
          ...
          },
          {
            ...
            paragraphs: [
              "En camion pizza, on a besoin d une sauce stable, simple a tenir et reguliere d un créneau a l autre.",
              "Une bonne reference tomate limite les ajustements inutiles et soutient la qualité en periode active.",
    ...
    conclusion: [
      ...
      "Elles s integrent particulierement bien a une pizza ou la pâte, la cuisson et la garniture doivent rester en equilibre.",
